    ...
    agents: {
      ...
      prompts: {
        html_layout_system_prompt: [
          ...
          "- THIS IS A SOCIAL MEDIA IMAGE, NOT A WEBPAGE — it gets screenshotted, not clicked. No web links, no URLs, no \"Read more\", no hashtags, no browser chrome.",
          "- Generous breathing room: minimum 32px padding (p-8) on all sides. Use flex/grid with gap-4, gap-6 for spacing. Leading-relaxed for body text.",
          "- Text containers: max-w-md or max-w-lg (max 65 chars per line). Use mb-4, mb-6 for vertical rhythm.",
        ...
        html_layout_user_instructions: [
          ...
          "- This is not a webpage. Produce one framed composition only. No URLs, no links, no hashtags.",
          ...
          "- Every element must have breathing room. Use p-6/p-8 padding, gap-4/gap-6 between elements, leading-relaxed for body text.",
